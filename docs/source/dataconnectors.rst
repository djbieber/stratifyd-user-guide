...
This chapter will discuss the different options available to access data.
...
Our Enterprise Data Connector is used to connect to internal databases or other 1st party data platforms in your organization.
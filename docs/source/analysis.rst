...
This chapter covers how to interpret the data generated by the Stratifyd Analytics Engine as well as how to interact with your data to find meaningful insights.
...
The Stratifyd Analytics Engine generates new datapoints based on your unstructured data.
...
Buzzwords
^^^^^^^^^^^
The Stratifyd Analytics Engine reads through every piece of text in a dataset and compares every possible combination of words.
...
Temporal information accompanying structured and unstructured data is paramount in understanding quantitative events and their potential underlying relationships across disparate data sets. Stratifyd utilizes time-series predictive analysis, deep learning, and event analysis to uncover trends and patterns across structured and unstructured data.

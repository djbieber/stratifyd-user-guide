...
.. figure:: topics.png
  ...
  Semantic Topics from Jamba Juice Yelp Reviews. Each topic is represented by a slice of the donut chart. The order (starting at 12:00 and moving clockwise) and size of the slice is determined by the statistical relevance or "tightness" of that topic. The color of the slice represents the sentiment.

  The words around each slice are the top N-Grams included in that topic.

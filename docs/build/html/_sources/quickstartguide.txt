...
Begin by :doc:`createaccount`, next, log in and check out some of the pre-built public dashboards in the folders on the homepage. 
...
Now you're ready to :doc:`widgeteditor` using your other datapoints to hone in on interesting segments within your data and discover topics and themes within your textual data.
